...
#
#
## Useful for centralised logging. Generally only used by larger orgs.
#
# locals {
...
#   main_logs_filter     = "logName: /logs/cloudaudit.googleapis.com%2Factivity OR logName: /logs/cloudaudit.googleapis.com%2Fsystem_event OR logName: /logs/cloudaudit.googleapis.com%2Fdata_access OR logName: /logs/cloudaudit.googleapis.com%2Faccess_transparency OR logName: /logs/compute.googleapis.com%2Fvpc_flows OR logName: /logs/compute.googleapis.com%2Ffirewall"
#   all_logs_filter      = ""
# }
#
...
#   log_sink_name          = "sk-s-logging-bkt"
#   parent_resource_id     = local.parent_resource_id
#   parent_resource_type   = local.parent_resource_type
#   include_children       = true
#   unique_writer_identity = true
...
#   version                     = "~> 7.1"
#   project_id                  = module.org_security.project_id
#   storage_bucket_name         = "bkt-${module.org_security.project_id}-org-logs-${random_string.suffix.result}"
