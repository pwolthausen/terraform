...
# resource "google_compute_global_address" "gke_ingress1" {
#   name = "mariadb1"
# }
...
#   private_cluster_config {
#     enable_private_nodes   = true
#     master_ipv4_cidr_block = "10.46.0.32/28"
#   }
...
#     labels = {
#       env = google_container_cluster.primary1.name
#     }
#     # preemptible  = true
#     machine_type = "n1-standard-1"
#     tags         = ["gke-node", "${google_container_cluster.primary1.name}"]
#     metadata = {
#       disable-legacy-endpoints = "true"
#     }
#   }
