...
#     command = "yes | gcloud beta --project ${var.project_id} sql instances patch ${google_sql_database_instance.app_db[count.index].name} --active-directory-domain=wolthausen.ca"
#   }
#   triggers = {
